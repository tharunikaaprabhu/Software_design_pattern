      ...
      <div className="flex flex-1">
        ...
        <div className="w-1/2 h-screen flex flex-col items-center justify-center bg-white p-8">
          ...
          <p className="text-xl text-gray-600 mb-8 text-center">
            Whether you're planning a small gathering or a large conference, our event portal helps you find, plan, and book the perfect venue. Let us handle the details, so you can focus on making memories.
          </p>
